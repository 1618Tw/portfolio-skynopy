...
export default function HomyLight({ project: _p, onClose }: Props) {
  return (
    <div className="bg-white text-black min-h-screen">
      ...
      <section className="relative px-6 sm:px-10 lg:px-20 mt-20 sm:mt-32 lg:mt-44">
      ...
      <section className="relative px-6 sm:px-10 lg:px-20 py-32 sm:py-44 lg:py-52">
        <div className="max-w-6xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 16 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
            {STATS.map((s, i) => (
              <motion.div
                ...
                className="aspect-square rounded-3xl bg-[#F4F2EE] flex flex-col items-center justify-center px-6 py-8 text-center border border-black/[0.06]"
              >
                <div
                ...
                <div className="mt-4 text-[11px] sm:text-xs uppercase tracking-[0.18em] text-black/60 max-w-[18ch] leading-[1.45]">
                  {s.label}
                </div>
              </motion.div>
            ))}
      ...
      <section className="relative px-6 sm:px-10 lg:px-20 pb-32 sm:pb-44">
